...
class LocalEmbeddingService:
    ...
    def __init__(self, model_path: Optional[str] = None):
        ...
        if model_path is None:
            model_path = os.getenv("BGE_MODEL_PATH", "/mnt/c/Users/Robert Moskwa/huggingface_models/hub/models--BAAI--bge-large-en-v1.5")
    ...
    def _load_model(self):
        ...
        try:
            ...
            print(f"BGE model loaded successfully from local path on device: {self.device}")
